...
function HouseKeepingTimeDetails({
  formData,
  updateFormData,
  handleNext,
  handleBack,
      ...
      <button
        onClick={async () => {
          ...
          if (!formData.hourlyRateStart && formData.hourlyRateStart !== 0)
            newErrors.hourlyRate = "Please set a minimum rate.";
          if (!formData.hourlyRateEnd && formData.hourlyRateEnd !== 0)
            newErrors.hourlyRate = "Please set a maximum rate.";
          if (
...
export default HouseKeepingTimeDetails;
