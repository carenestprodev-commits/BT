    ...
    if (activeTab === "verify") {
      ...
      try {
        ...
        const verificationPlans = (data || []).filter(
          (p) => p.plan_kind === "verification" && p.audience === "seeker",
        );
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <div className="flex flex-col gap-4 sm:gap-6 items-stretch sm:items-start">
                    ...
                    <div className="flex-shrink-0 self-center sm:self-start">
                      {previewUrls.uploadedPhoto || formData.uploadedPhoto ? (
                        <img
                          src={
                            previewUrls.uploadedPhoto || formData.uploadedPhoto
                          }
                    ...
                    <div className="flex-1 w-full">
                      {/* Show Change Image button if photo already uploaded */}
                      {(previewUrls.uploadedPhoto ||
                        formData.uploadedPhoto) && (
                        <div className="mb-4 flex gap-2">
                          <label
                            htmlFor="profilePhoto"
                            className="px-4 py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 cursor-pointer text-sm sm:text-base"
                          >
                            Change Image
                          </label>
                        </div>
            ...
            : "border-gray-300 bg-gray-50"
                  ...
                  >
                    ...
                    <label
                      ...
                      className="cursor-pointer block"
                    >
                      {previewUrls.uploadedId ? (
                        <div className="flex flex-col items-center gap-3">
                          <img
                            src={previewUrls.uploadedId}
                            alt="Government ID Preview"
                            className="max-h-64 max-w-sm rounded-lg border border-blue-200 object-contain"
                          />
                          <div className="flex gap-2">
                            <label
                              htmlFor="governmentId"
                              className="px-4 py-2 bg-blue-500 text-white rounded font-medium hover:bg-blue-600 cursor-pointer text-sm"
                            >
                              Change Image
                            </label>
                            <button
                              ...
                              className="px-4 py-2 bg-red-100 text-red-600 rounded font-medium hover:bg-red-200 text-sm"
                            >
                              Remove
                            </button>
                          </div>
                        ...
                        <div className="flex flex-col gap-4">
                          ...
                          <label
                            htmlFor="governmentId"
                            className="px-4 py-2 bg-blue-500 text-white rounded font-medium hover:bg-blue-600 cursor-pointer text-sm text-center"
                          >
                            Change Image
                          </label>
                        </div>
