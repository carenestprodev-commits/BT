...
function ChildSummary({ formData, updateFormData, handleNext, handleBack, currentStep = 7, totalSteps = 8 }) {
  ...
  React.useEffect(() => {
    ...
    if (!preview) {
      ...
      if (raw) {
        try { const parsed = JSON.parse(raw); if (parsed.preview) { /* nothing */ } }
        catch (e) {}
      }
    }
  }, [preview])
