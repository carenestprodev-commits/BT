  ...
  return (
    <>
      ...
      <div className="w-full max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        {/* Next Button */}
        <button onClick={() => { dispatch(saveStep({ stepName: 'user_data', data: { first_name: formData.firstName || '', last_name: formData.lastName || '' } })); handleNext(); }} className="w-full bg-[#0093d1] text-white text-lg font-medium py-3 rounded-md hover:bg-[#007bb0] transition mt-8">
          Next
        </button>
      </div>
    </>
