...
import { initiateActivityPayment, clearPaymentState, clearActivityStarted, clearActivityEnded } from "../../../Redux/StartActivity";
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                    <button
                      ...
                      onClick={() => { setMenuOpen(false); setShowPayment(true); }}
                    >
