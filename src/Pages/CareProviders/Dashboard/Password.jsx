          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full border rounded-lg px-4 py-3 bg-white text-gray-800 pr-10 ${touched.password && !isPasswordStrong ? 'border-red-400' : 'border-gray-200'}`}
                value={password}
              ...
              {touched.password && !isPasswordStrong && (
                <div className="text-xs text-red-500 mt-1">Password must be at least 8 characters, include uppercase, lowercase, number, and special character.</div>
              )}
          </div>
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="Input password"
                className={`w-full border rounded-lg px-4 py-3 bg-white text-gray-800 pr-10 ${touched.confirm && !isConfirmMatch ? 'border-red-400' : 'border-gray-200'}`}
