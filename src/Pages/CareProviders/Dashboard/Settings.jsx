      ...
      <div className="flex-1 font-sfpro px-4 md:px-8 py-8 md:ml-64">
        ...
        <div className="max-w-xl">
          <div className="space-y-4">
            <button
              onClick={() =>
                navigate("/careproviders/dashboard/verify_identity")
              }
              className="w-full flex items-center justify-between bg-white border border-gray-100 rounded-lg px-6 py-4 text-gray-800 text-base font-medium hover:bg-gray-50"
            >
              <span>Verify my Identity</span>
              <span className="bg-[#fff7e6] text-[#e6a23c] text-xs font-semibold px-3 py-1 rounded">
                Pending
              </span>
            </button>
            <button
            ...
            <button
              onClick={() => navigate("/careproviders/dashboard/password")}
              className="w-full flex items-center justify-between bg-white border border-gray-100 rounded-lg px-6 py-4 text-gray-800 text-base font-medium hover:bg-gray-50"
            >
              <span>Password</span>
              <span className="text-gray-400 text-xl">&gt;</span>
