...
const SignUpModal = ({ isOpen, onClose, selectedCategory }) => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // Build canonical profile_data
      const profileData = {
        service_category:
          mergedProfile.service_category || mergedProfile.serviceCategory || "",
        work_reason:
          mergedProfile.work_reason || mergedProfile.workReason || "",
        profile_title:
          mergedProfile.title ||
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg p-6 md:p-8 max-h-[90vh] overflow-y-auto animate-fadeIn font-sfpro">
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            ...
            <a
              href="https://app.carenestpro.com/careproviders/login"
        ...
        <div className="flex flex-col lg:flex-row lg:items-center mb-4 lg:mb-6 gap-3 lg:gap-0">
          <div className="flex items-center">
            ...
            <h3 className="text-sm lg:text-lg text-gray-700">
              What category of Care are you experienced in?
            </h3>
          </div>
