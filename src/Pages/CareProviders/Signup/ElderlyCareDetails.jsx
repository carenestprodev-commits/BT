...
/>
        ...
        <CheckboxGroup
          ...
          options={[
            "Hypertension", "Diabetes", "Clean-up help", "Healthy diet", "CPR trained", "Non-smoker", "Medication reminder", "Can drive",
            "Palliative care", "Willing to live-in", "Background checked", "Speaks Yoruba", "Speaks Igbo", "Speaks Hausa", "Special Needs experience"
          ]}
        ...
        <CheckboxGroup
          ...
          options={[
            "First Aid Certificate", "CPR Certificate", "Speech Therapist", "Special Needs Care Training",
            "Physical Therapist", "Registered Nurse", "Occupational Therapist", "Healthcare Assistance"
          ]}
        ...
        <div className="flex items-center mt-6">
          ...
          <label htmlFor="autoSend" className="text-sm text-gray-700">I would like to automatically send the above application to potential caregivers</label>
        </div>
