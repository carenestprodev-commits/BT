              ...
              {!loading &&
                ...
                visibleRows.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-4 text-[#475467]">
                      {row.agreed_rate
                        ? "₦" + Number(row.agreed_rate).toLocaleString()
                        : "—"}
                    </td>
                    <td className="px-3 py-4 text-[#475467]">
                      {formatDate(row.hired_at)}
        ...
        <>
          ...
          <aside className="fixed inset-y-0 right-0 z-50 flex w-full max-w-[440px] flex-col bg-white shadow-2xl">
            <div className="flex items-start justify-between border-b border-[#EAECF0] p-6">
              <div>
                <h2 className="text-xl font-bold text-[#0E2F43]">
                  Booking details
                </h2>
                <p className="mt-1 text-xs text-[#A6A6A7]">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <div className="space-y-3 text-sm">
                {[
                  ...
                  [
                    "Agreed rate",
                    selectedJob.agreed_rate
                      ? "₦" + Number(selectedJob.agreed_rate).toLocaleString()
                      : "—",
                  ],
                  [
                    "Payment status",
