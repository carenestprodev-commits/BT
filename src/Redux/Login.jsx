  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(loginUser.fulfilled, (state, action) => {
        ...
        state.refresh = action.payload.refresh || localStorage.getItem(LS_REFRESH)
        state.user = action.payload.user || (localStorage.getItem(LS_USER) ? JSON.parse(localStorage.getItem(LS_USER)) : null)
      })
