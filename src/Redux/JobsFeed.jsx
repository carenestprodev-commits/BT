...
export const fetchJobsFeed = createAsyncThunk(
  ...
  async ({ search = "" } = {}, { rejectWithValue }) => {
    try {
      ...
      console.log("Jobs Feed API Response:", data);
...
const slice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchJobsFeed.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(fetchJobsFeed.fulfilled, (state, action) => {
        state.loading = false;
        state.jobs = action.payload;
      })
      .addCase(fetchJobsFeed.rejected, (state, action) => {
        state.loading = false;
      ...
      .addCase(submitBooking.rejected, (state, action) => {
        state.bookingLoading = false;
        state.bookingError = action.payload || action.error;
      });
  },
});
